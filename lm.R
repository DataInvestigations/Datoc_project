...
# shows that the points are not evenly distributed about the reference line. In terms of
# the normality of the residuals, the majority of the points fall along the reference line 
# and the qq plot looks relatively normal. However, there are some heavy tails occurring therefore 
# it is more plausible that the assumption of normality is violated. Given the residuals versus 
# leverage plot, there are three points that have potential to have significant influence on the 
# regression line. However, these points do not exceed the cook's distance line. Also, on the 
# influential observations plot, there are definitely some points displaying outliers. 
