...
- Completed ggplot assignment 
  ...
  - Added another that was an extension of the previous boxplot for grouping by season
  - Added a final ggplot that displays the difference between the density of temperatures of infected compared to healthy bats
